 ...
 */
public class LaporanKedudukanKewanganLesen1Generator
{
	...
	public static void generate(File file, String[] data) throws Exception
	{
		...
		a_cells[6].setBorderWidthTop(0.5f);
		a_cells[6].setBorderWidthBottom(0.5f);
		a_cells[6].setUseBorderPadding(true);
		...
		content.addCell(new Phrase("\nWang Amanah Kongsi", contentFont));
		content.addCell(new Phrase("RM", contentFont));
		content.addCell(a_cells[3]);		
		content.addCell(new Phrase("\nBayaran Pendahuluan Royalti dan Ses yang telah dikutip",
				contentFont));
		content.addCell(new Phrase("RM", contentFont));
